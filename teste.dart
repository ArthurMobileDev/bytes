...
void testByteArrayBuilder() {
  ...
  builder.addString("M4çã v³®D& ぁ🫵", encoder: Encoding.utf8);
  ...
  builder.addString("M4çã v³®D& ぁ🫵", encoder: Encoding.latin1);
  ...
  builder.addString("M4çã v³®D& ぁ🫵", encoder: Encoding.utf16);
  ...
  builder.addString("M4çã v³®D& ぁ🫵", encoder: Encoding.ascii);
  ...
  // builder.addMD5("oi", hasSize: true);
  // assert(compareList(builder.build(), [0x20, 0x61, 0x32, 0x65, 0x36, 0x33, 0x65, 0x65, 0x30, 0x31, 0x34, 0x30, 0x31, 0x61, 0x61, 0x65, 0x63, 0x61, 0x37, 0x38, 0x62, 0x65, 0x30, 0x32, 0x33, 0x64, 0x66, 0x62, 0x62, 0x38, 0x63, 0x35, 0x39]));
  //
  // builder.addMD5("oi", hasSize: false);
  // assert(compareList(builder.build(), [0x20, 0x61, 0x32, 0x65, 0x36, 0x33, 0x65, 0x65, 0x30, 0x31, 0x34, 0x30, 0x31, 0x61, 0x61, 0x65, 0x63, 0x61, 0x37, 0x38, 0x62, 0x65, 0x30, 0x32, 0x33, 0x64, 0x66, 0x62, 0x62, 0x38, 0x63, 0x35, 0x39, 0x61, 0x32, 0x65, 0x36, 0x33, 0x65, 0x65, 0x30, 0x31, 0x34, 0x30, 0x31, 0x61, 0x61, 0x65, 0x63, 0x61, 0x37, 0x38, 0x62, 0x65, 0x30, 0x32, 0x33, 0x64, 0x66, 0x62, 0x62, 0x38, 0x63, 0x35, 0x39]));
...
void testByteArrayReader() {
  ...
  assert(reader.readString(decoder: Encoding.utf8) == "M4çã v³®D& ぁ🫵");
  assert(reader.readString(decoder: Encoding.latin1) == "M4çã v³®D& \u001F\u001F\u001F");
  ...
  assert(reader.readString(decoder: Encoding.utf16) == "M4çã v³®D& ぁ🫵");
  assert(reader.readString(decoder: Encoding.ascii) == "M4\u001F\u001F v\u001F\u001FD& \u001F\u001F\u001F");
